@total-core
Feature: Login as Admin and delete the Contributor user used for testing Immersive Page CT

  Scenario: Login as Admin and delete the Contributor user used for testing Immersive Page CT
    #Login
    Given I go to "/user"
